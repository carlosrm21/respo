          ...
          <div className="glass-card" style={{ padding: '80px 40px', position: 'relative' }}>
            <div style={{ minWidth: 800, display: 'flex', justifyContent: 'space-between', position: 'relative', zIndex: 10 }}>
              ...
              <div className="node-pulse" style={{ textAlign: 'center', width: 160, zIndex: 1 }}>
                <div style={{ width: 100, height: 100, background: 'transparent', borderRadius: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px', transition: 'transform 0.3s' }}>
                  <img src="/logo.png?v=101" alt="RestoPOS" style={{ width: '100%', height: '100%', objectFit: 'contain', mixBlendMode: 'screen' }} />
                </div>
